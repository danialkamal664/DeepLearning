...
trainGenerator = trainGenerator.flow_from_directory(
    trainDir, target_size=(150, 150), batch_size=20, class_mode="categorical"
)

testGenerator = testGenerator.flow_from_directory(
    testDir, target_size=(150, 150), batch_size=20, class_mode="categorical"
)
...
model = keras.models.Sequential(
    [
        keras.layers.Conv2D(
            filters=32, kernel_size=(3, 3), activation="relu", input_shape=(150, 150, 3)
        ),
